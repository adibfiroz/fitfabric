    ...
    <div className="h-full max-w-[1900px] max-w-sc mx-auto">
      ...
      <div className="my-16 px-3 lg:px-16 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
          <div className="rounded-2xl  bg-[#f8ffe5] dark:bg-[#020817] dark:border">
        ...
        <div className="flex gap-5 mt-5 scrollMobile">
          <div className=" shadow-xl relative dark:border rounded-xl pt-32 md:pt-4 p-4 min-w-64 md:min-w-fit md:pl-32 flex-1 md:h-32 overflow-hidden">
            <Link href="/blogs/package-info">
              <div className=" absolute skew dark:bg-black top-0 left-0 right-0 bottom-52 md:bottom-0 w-full h-full overflow-hidden">
          ...
          <div className="group/item shadow-xl relative dark:border rounded-xl pt-32 md:pt-4 p-4 min-w-64 md:min-w-fit md:pl-32 flex-1 md:h-32 overflow-hidden">
            <Link href="/blogs/package-info">
