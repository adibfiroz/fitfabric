    ...
    return (
        <div>
            <div className="flex lg:grid lg:grid-cols-5 gap-9  mt-10 scrollMobile pt-10 lg:pt-0">
                <div>
                    <ul className=" bg-white custom-shadow w-[220px] lg:w-auto p-10 uppercase rounded- 2xl:text-lgxl text-sm 2xl:text-lg">
                        ...
                        {data.classPage.classList[0].list.map((item) => (
                            <li className="mb-1" key={item.name}>
                                <Link href="/" className="hover:underline uppercase text-[#3d4939] text-[11px] 2xl:text-[14px] font-extrabold ">
                                    {item.name}
                ...
                <div className="">
                    <ul className=" bg-white custom-shadow w-[220px] lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg">
                        ...
                        {data.classPage.classList[1].list.map((item) => (
                            <li className="mb-1" key={item.name}>
                                <Link href="/" className="hover:underline text-[#3d4939] text-[11px] 2xl:text-[14px] font-extrabold">
                                    {item.name}
                                    <ChevronRight size={12} className=" inline-block  text-[#6cce40]" />
                                </Link>
                            </li>
                    ...
                    <ul className=" bg-white custom-shadow w-[220px] lg:w-auto p-10 rounded-xl text-sm 2xl:text-lg mt-9">
            ...
            <div className="flex justify-center lg:mt-10">
                <Button variant="primaryGreen" className="w-full sm:w-auto rounded-full text-sm 2xl:text-lg px-8">
